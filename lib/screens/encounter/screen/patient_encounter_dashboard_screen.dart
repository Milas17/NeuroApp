          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                ReadMoreText(
                  data.description.validate(value: " -- "),
                  trimLines: 2,
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Divider(height: 8),
                                    Text(encounterData.name.validate().capitalizeFirstLetter(), style: primaryTextStyle(size: 14)),
                                  ],
                                ).expand(),
                                16.width,
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Divider(height: 8),
                                    Text(encounterData.frequency.validate(), style: primaryTextStyle(size: 14)),
                                  ],
                                ).expand(),
                              ],
                            ),
