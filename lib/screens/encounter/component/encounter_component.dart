          ...
          if (showEncounterEdit)
            SlidableAction(
              onPressed: (BuildContext context) {
                AddEncounterScreen(patientId: data.patientId.validate().toInt(), patientEncounterData: data).launch(context, pageRouteAnimation: pageAnimation, duration: pageAnimationDuration).then((value) {
              ...
              children: [
                ...
                if (isReceptionist() || isPatient())
                  RichTextWidget(list: [
                    ...
                    TextSpan(text: '${locale.lblDr}' + data.doctorName.validate().capitalizeEachWord(), style: primaryTextStyle()),
                  ]),
                4.height,
                RichTextWidget(
                  list: [
