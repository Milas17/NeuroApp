...
import 'package:kivicare_flutter/screens/doctor/components/multi_select_clinic_drop_down.dart';
                                    ...
                                    if (selectedClinicList.length > 1)
                                      ...
                                      if (!isUpdate) {
                                        ...
                                        selectedDoctorData = setDoctor(
                                          ServiceData(
                                              clinicId: selectedClinicData?.id, clinicName: selectedClinicLocalList.first.name.validate(), serviceId: isUpdate ? widget.serviceData?.serviceId : null, id: isUpdate ? widget.serviceData?.id : null),
                                          userData: UserModel(),
                                        );
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              8.width,
                                              Text('${locale.lblDr}${data.displayName.validate().split(' ').first}', style: primaryTextStyle(color: context.iconColor), maxLines: 1, overflow: TextOverflow.ellipsis).expand(),
