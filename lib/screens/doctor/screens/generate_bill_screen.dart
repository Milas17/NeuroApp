...
class _GenerateBillScreenState extends State<GenerateBillScreen> {
  ...
  void handleDiscountInput(String value) {
    ...
    if (value.startsWith('.')) {
      ...
      discountCont.selection = TextSelection.fromPosition(
          TextPosition(offset: discountCont.text.length));
      return;
    }
    try {
        ...
        body: Stack(
          ...
          children: [
            AnimatedScrollView(
              ...
              children: [
                Text(locale.lblNote + " : " + locale.lblSwipeLeftToDelete,
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            AppTextField(
                              ...
                              onChanged: (p0) {
                                ...
                                if (billItemData
                                  ...
                                  getTotal(
                                      discount: p0.validate(
                                          value: discountCont.text));
                                }
                              },
                              onFieldSubmitted: (p0) {
                                if (billItemData
                        ...
                        Divider(),
                        if (patientBillData?.taxes != null &&
                            patientBillData!.taxes.validate().isNotEmpty)
                          Row(
                            children: [
                              Text(locale.lblTax,
