...
class _AddPatientScreenState extends State<AddPatientScreen> {
  ...
  void savePatientDetails() async {
    if (formKey.currentState!.validate()) {
      if (genderCont.text.isEmptyOrNull) {
        isFirstTime = false;
        setState(() {});
        return;
      }
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(locale.lblDone, style: boldTextStyle()).appOnTap(
                      () {
                        if (userStore.userRole == UserRoleDoctor || userStore.userRole == UserRoleReceptionist) {
            ...
            child: AnimatedScrollView(
              ...
              children: [
                ...
                GenderSelectionComponent(
                  ...
                  isError: !isFirstTime && genderCont.text.isEmptyOrNull,
                  onTap: (String value) {
                    genderCont.text = value;
                    setState(() {});
                  },
                ),
                if (!isFirstTime && genderCont.text.isEmptyOrNull)
                  Padding(
