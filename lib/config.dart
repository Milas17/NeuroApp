const APP_NAME = 'Neuro Care Telemed';
...
var COPY_RIGHT_TEXT = '© ${DateTime.now().year}. Propulsé avec ♡ par NeuroCare Connect';
...
const STRIPE_CURRENCY_CODE = 'XOF';
const STRIPE_MERCHANT_COUNTRY_CODE = 'BJ';
