...
mixin _$AppStore on AppStoreBase, Store {
  ...
  late final _$wcNonceAtom =
      Atom(name: 'AppStoreBase.wcNonce', context: context);

  @override
  String get wcNonce {
    _$wcNonceAtom.reportRead();
    return super.wcNonce;
  }

  @override
  set wcNonce(String value) {
    _$wcNonceAtom.reportWrite(value, super.wcNonce, () {
      super.wcNonce = value;
    });
  }

  late final _$apiNonceAtom =
      Atom(name: 'AppStoreBase.apiNonce', context: context);

  @override
  String get apiNonce {
    _$apiNonceAtom.reportRead();
    return super.apiNonce;
  }

  @override
  set apiNonce(String value) {
    _$apiNonceAtom.reportWrite(value, super.apiNonce, () {
      super.apiNonce = value;
    });
  }
  ...
  late final _$isFromUpcomingAtom =
      Atom(name: 'AppStoreBase.isFromUpcoming', context: context);

  @override
  int get isFromUpcoming {
    _$isFromUpcomingAtom.reportRead();
    return super.isFromUpcoming;
  }

  @override
  set isFromUpcoming(int value) {
    _$isFromUpcomingAtom.reportWrite(value, super.isFromUpcoming, () {
      super.isFromUpcoming = value;
    });
  }
  ...
  void setUpcoming(int status) {
    final _$actionInfo = _$AppStoreBaseActionController.startAction(
        name: 'AppStoreBase.setUpcoming');
    try {
      return super.setUpcoming(status);
    } finally {
  ...
  void setAppVersion(String version) {
    final _$actionInfo = _$AppStoreBaseActionController.startAction(
        name: 'AppStoreBase.setAppVersion');
    try {
      return super.setAppVersion(version);
    } finally {
      _$AppStoreBaseActionController.endAction(_$actionInfo);
    }
  }
