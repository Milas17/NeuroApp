...
List<FilterModel> getOrderStatus() {
  ...
  list.add(FilterModel(value: OrderStatus.any, title: locale.lblAny));
  list.add(FilterModel(value: OrderStatus.pending, title: locale.lblPending, statusColor: pendingStatusColor));
  list.add(FilterModel(value: OrderStatus.onHold, title: locale.lblOnHold, statusColor: onHoldStatusColor));
  list.add(FilterModel(value: OrderStatus.completed, title: locale.lblCompleted, statusColor: completedStatusColor));
  list.add(FilterModel(value: OrderStatus.cancelled, title: locale.lblCancelled, statusColor: cancelledStatusColor));
  list.add(FilterModel(value: OrderStatus.refunded, title: locale.lblRefunded, statusColor: refundedStatusColor));
